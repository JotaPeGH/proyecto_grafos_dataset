...
function addEdgeKruskal(peso, nodoFrom, nodoTo) {
  try {
    edgesKruskal.add({
      id: peso,
      from: nodoFrom,
...
function drawKruskal() {
  ...
  nodesKruskal = new vis.DataSet();
  nodesKruskal.on("*", function () {
  ...
  var options = {};
  networkKruskal = new vis.Network(container, data, options);
}
*/
